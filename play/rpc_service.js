...
var mutex = require('idanode-common/mutex.js');
var storage = require('idanode-common/storage.js');
var constants = require('idanode-common/constants.js');
var validationUtils = require("idanode-common/validation_utils.js");
var wallet_id;
...
function initRPC() {
	...
	var balances = require('idanode-common/balances.js');
